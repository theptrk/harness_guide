"""Level 5 — stream model text and record enough events to replay it.
...
def save_response(chat_file_path, turn_id: str, response) -> None:
    """Save canonical output, excluding incomplete items from API replay."""
...
def stream_response(
    ...
    """Print and persist text deltas, then return the terminal response."""
    request_options = {}
    ...
    while True:
        ...
        try:
            while True:
                ...
                save_response(chat_file_path, turn_id, response)
